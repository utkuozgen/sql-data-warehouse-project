...
--------------------------------------------------------------------------
Aim:
    Script creates views in Gold Layer in the data warehouse dropping them if they exist.
    The Gold Layer represents the final dimensions and fact tables (Star Schema).
    Each view performs transformations and combine data from Silver Layer to
    produce clean and business-ready dataset.
*/
